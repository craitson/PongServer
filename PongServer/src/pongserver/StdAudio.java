...
/**
 * ****************************************************************************
 * Compilation: javac StdAudio.java Execution: java StdAudio Dependencies: none
 *
 * Simple library for reading, writing, and manipulating .wav files.
 *
 *
 * Limitations ----------- - Does not seem to work properly when reading .wav
 * files from a .jar file. - Assumes the audio is monaural, with sampling rate
 * of 44,100.
 *
 *****************************************************************************
 */
...
public final class StdAudio {
    ...
    /**
     * Writes one sample (between -1.0 and +1.0) to standard audio. If the
    ...
    /**
     * Writes the array of samples (between -1.0 and +1.0) to standard audio. If
     * a sample is outside the range, it will be clipped.
     *
    ...
    /**
     * Reads audio samples from a file (in .wav or .au format) and returns them
     * as a double array with values between -1.0 and +1.0.
     *
    ...
    /**
     * Plays an audio file (in .wav, .mid, or .au format) in a loop in a
     * background thread.
     *
     * @param filename the name of the audio file
     */
    public static AudioClip loop(String filename) {
        URL url = null;
        try {
            File file = new File(filename);
            if (file.canRead()) {
